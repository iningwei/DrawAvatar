...
#pragma warning restore 0414
        ...
        private static Sprite infoLog;
        public static Sprite InfoLog
        {
            get
            {
                if (infoLog == null)
                {
                    infoLog = Resources.Load<Sprite>("IngameDebugConsole/IconInfo");
                }
                return infoLog;
            }
        }

        private static Sprite warningLog;
        public static Sprite WarningLog
        {
            get
            {
                if (warningLog == null)
                {
                    warningLog = Resources.Load<Sprite>("IngameDebugConsole/IconWarning");
                }
                return warningLog;
            }
        }

        private static Sprite errorLog;
        public static Sprite ErrorLog
        {
            get
            {
                if (errorLog == null)
                {
                    errorLog = Resources.Load<Sprite>("IngameDebugConsole/IconError");
                }
                return errorLog;
            }
        }
...
#pragma warning restore 0649
        ...
        public static Sprite GetSpriteByLogType(LogType logType)
        {
            switch (logType)
            {
                case LogType.Error:
