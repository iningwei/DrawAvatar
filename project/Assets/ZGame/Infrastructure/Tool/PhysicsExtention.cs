...
public static class PhysicsExtension
{
    ...
    public static List<Collider2D> OverlapCapsule2D(CapsuleCollider2D capsule, int layerMask = Physics.DefaultRaycastLayers)
    {
        ...
        capsule.OverlapCollider(filter, results);
        return results;
    }
